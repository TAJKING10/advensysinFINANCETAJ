export default {
  ...
  header: {
    ...
    locationSwitcher: 'Select Location',
    phone: 'Phone',
    email: 'Email'
  },
  ...
  hero: {
    slide1: {
      subtitle: 'Protect Your Future Today',
      title: 'Comprehensive Insurance Solutions',
      description: 'Get personalized insurance coverage that fits your unique needs and budget. Our expert team provides comprehensive solutions for individuals and businesses.',
      cta: 'Get Free Quote'
    },
    slide2: {
      subtitle: 'Secure Your Tomorrow',
      title: 'Financial Planning Excellence',
      description: 'Professional financial planning services to help you achieve your goals. From retirement planning to investment strategies, we have you covered.',
      cta: 'Learn More'
    },
    slide3: {
      subtitle: 'Trust the Professionals',
      title: 'Expert Insurance Advice',
      description: 'With years of experience in the insurance industry, our certified professionals provide expert guidance for all your insurance needs.',
      cta: 'Contact Us'
    },
    features: {
  ...
  services: {
    ...
    items: {
      autoInsurance: {
        ...
        description: 'Comprehensive coverage for your vehicles with competitive rates and excellent customer service.',
        features: ['Collision Coverage', 'Liability Protection', '24/7 Claims Support', 'Roadside Assistance']
      },
      healthInsurance: {
        title: 'Health Insurance',
        description: 'Protect your health and finances with our range of medical insurance plans.',
      ...
      lifeInsurance: {
        ...
        features: ['Term Life', 'Whole Life', 'Universal Life', 'Investment Options']
      },
      businessInsurance: {
        title: 'Business Insurance',
        description: 'Comprehensive business protection including liability, property, and worker compensation.',
        features: ['General Liability', 'Property Coverage', 'Workers Comp', 'Cyber Protection']
      },
      propertyInsurance: {
        title: 'Property Insurance',
        description: 'Protect your home and personal belongings with our property insurance solutions.',
        features: ['Home Insurance', 'Renters Insurance', 'Condo Coverage', 'Personal Property']
      },
      financialPlanning: {
        title: 'Financial Planning',
        description: 'Professional financial planning and investment advisory services.',
        features: ['Retirement Planning', 'Investment Advice', 'Tax Planning', 'Estate Planning']
      }
    }
  },
  ...
  about: {
    ...
    vision: {
      title: 'Our Vision',
      description: 'To be the leading insurance provider in the region, known for our innovative solutions, exceptional customer service, and commitment to our clients\' success.'
    },
    values: {
      title: 'Our Values',
      subtitle: 'The principles that guide everything we do and define who we are as a company.',
      integrity: 'Integrity',
  ...
  // Footer
  footer: {
    description: 'Your trusted partner for comprehensive insurance and financial solutions. Protecting what matters most to you.',
    quickLinks: {
      title: 'Quick Links',
      home: 'Home',
      about: 'About Us',
    ...
    services: {
      ...
      insurance: 'Insurance Services',
      dedicatedLife: 'Dedicated Life Insurance',
      investment: 'Investment Adviser',
      banking: 'Broker in Bank',
      privatePension: 'Private Pension Plan'
    },
    ...
    newsletter: {
      title: 'Newsletter',
      description: 'Subscribe to our newsletter for the latest updates and insurance tips.',
    ...
    oriasAuthorization: 'ORIAS Authorization',
    copyright: '© 2024 Advensys Insurance Finance. All rights reserved.',
    developedBy: 'Developed by',
    legalInformation: 'Legal Information',
    oriasAuthorization: 'Authorization ORIAS/LPS: 21003660'
  },
  ...
  legal: {
    ...
    identification: {
      ...
      registrationText: 'Registered with ORIAS under no.21003660 as:',
      services: {
        investment: 'Financial investment advice, member of LA COMPAGNIE CIF, an association approved by the Autorité des Marchés Financiers',
        insurance: 'Insurance brokerage',
        banking: 'Brokerage or intermediary in banking operations, services and payments'
      },
      civilLiability: 'Civil liability',
      civilLiabilityText: 'underwritten by MMA IARD 14 Boulevard Marie et Alexandre Oyon 72030 Le Mans CEDEX 9.',
      disclaimer: 'Cannot receive any instrument, fund or value.'
    },
    generalConditions: {
      title: 'GENERAL CONDITIONS OF USE',
      information: 'The information on this site is not contractual and may contain technical inaccuracies or typographical errors. This information may be periodically changed and changes will be incorporated in new editions.',
      responsibility: 'The "Advensys Insurance Finance S.A.R.L." cannot be held responsible for errors or omissions in the information disseminated or for technical problems encountered on the site and on all the other sites to which links are established, or for any interpretation of the information published on this site.',
      changes: '"Advensys Insurance Finance S.A.R.L." may, at any time, without notice, make improvements or changes to the products, programs or services described on this site.',
      direction: 'The direction of the publication is ensured by the leader of the "Advensys Insurance Finance S.A.R.L.".'
    },
    gdpr: {
      title: 'GDPR',
      rights: 'Internet users have a right of access, rectification, limitation, opposition for legitimate reasons, right to be forgotten, a right to portability subject to the applicable legal and regulatory provisions. They also have the option of filing a complaint with the CNIL.',
      exercise: 'This right is exercised by post, with proof of identity, to: Advensys Insurance Finance S.A.R.L. – Irfan Abdul- 66 avenue des Champs Elysées, 75008 Paris'
    },
    designHost: {
      title: 'DESIGN, WEB DESIGN AND HOST',
      design: 'Design',
    ...
    dataProtection: {
      ...
      commitment: 'The "Advensys Insurance Finance S.A.R.L" is committed to a process of protecting the personal data of its Internet users, in accordance with the Data Protection Act dated January 6, 1978 as amended, as well as with the General Data Protection Regulation No. 2016/679 (GDPR).'
    },
    dataController: {
      title: 'RESPONSIBLE FOR THE PROCESSING',
      definition: 'For personal data, within the meaning of the GDPR, collected in the context of navigation, the data controller is "Advensys Insurance Finance S.A.R.L", represented by its manager.',
      processing: 'Personal data is only processed by the data controller and by persons authorized by the data controller with regard to the tasks they carry out.'
    },
    dataCollection: {
      title: 'COLLECTION OF PERSONAL DATA',
      definition: 'According to the Data Protection Act and the General Data Protection Regulations, any information relating to a natural person identified or who can be identified, directly or indirectly, by reference to an identification number or to one or more elements which are specific, constitutes personal data.',
      consent: 'All personal data concerning Internet users is collected directly from them. The "Advensys Insurance Finance S.A.R.L" undertakes to obtain the consent of Internet users and/or to allow them to oppose the use of their personal data.'
    },
    dataTypes: {
      title: 'TYPES OF DATA AND PURPOSE OF COLLECTION',
      collected: 'The following data from Internet users may be collected by the "Advensys Insurance Finance S.A.R.L": surname, first name, address, email and IP address for Google Analytics',
      purpose: 'This collected data is mainly processed for: allow navigation on the site, produce statistics.',
      legitimateInterest: 'The collection of personal data is based on the legitimate interest of the "Advensys Insurance Finance S.A.R.L" to offer:',
      services: {
      ...
      location: 'The processing carried out by the "Advensys Insurance Finance S.A.R.L" is located exclusively in Metropolitan France.'
    },
    dataRetention: {
  ...
  servicesPage: {
    ...
    whyChooseUs: {
      ...
      personalized: {
        title: 'Personalized Service',
        description: 'Tailored insurance solutions to meet your specific needs.'
      },
      competitive: {
        title: 'Competitive Rates',
        description: 'Best rates in the market with maximum coverage.'
      },
      support: {
        title: '24/7 Support',
  ...
  // Contact Page
  contactPage: {
    title: 'Contact Advensys Insurance Finance',
    subtitle: 'Get Expert Insurance Advice Today',
    description: 'Our team of insurance experts is ready to help you find the perfect coverage for your needs. Contact us today for a free consultation and quote.',
    locations: {
      title: 'Our Locations',
      visitUs: 'Visit Us',
      callUs: 'Call Us',
